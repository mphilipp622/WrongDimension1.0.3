...
namespace com.ootii.Input
{
    ...
    public class EnumInput
    {
        ...
        public const int PAUSE = 83;            //;
        public const int PRINT = 84;            //;
        ...
        public const int GAMEPAD_0_BUTTON = 178; // A
        public const int GAMEPAD_1_BUTTON = 179; // B
        public const int GAMEPAD_2_BUTTON = 180; // X
        public const int GAMEPAD_3_BUTTON = 181; // Y
        ...
        static EnumInput()
        {
            ...
            EnumNames.Add(EnumInput.PAUSE, "PAUSE"); //83;        //;
            EnumNames.Add(EnumInput.PRINT, "PRINT"); //84;        //;
